...
<form action="https://formsubmit.co/trivselundbrf@gmail.com" method="POST">
  ...
  <label><input type="checkbox" name="Extraanalys" value="Ja"> Beställning utanför standardutbudet i Nivå 1-3 (500 kr/timme för tillägg utanför basutbud) </label><br><br>
